...
@testset "arithmetic" begin
    ...
    @test mod(SafeInt32(7), SafeInt16(-2)) === SafeInt32(rem(7,-2))
    @test fld(SafeInt32(7), SafeInt16(2)) === SafeInt32(fld(7,2))
    @test cld(SafeInt32(7), SafeInt16(2)) === SafeInt32(cld(7,2))

    @test SafeInt16(7) + Int32(2) === SafeInt32(7+2)
    @test SafeInt8(7) - Int64(2) === SafeInt64(7-2)
    ...
    @test mod(SafeInt32(7), Int16(-2)) === SafeInt32(rem(7,-2))
    ...
    @test Int32(7) * SafeInt16(2) === SafeInt32(7*2)
    @test div(Int32(7), SafeInt16(2)) === SafeInt32(div(7,2))
    @test rem(Int32(7), SafeInt16(-2)) === SafeInt32(rem(7,-2))
    @test mod(Int32(7), SafeInt16(-2)) === SafeInt32(rem(7,-2))
    @test fld(Int32(7), SafeInt16(2)) === SafeInt32(fld(7,2))
    @test cld(Int32(7), SafeInt16(2)) === SafeInt32(cld(7,2))
