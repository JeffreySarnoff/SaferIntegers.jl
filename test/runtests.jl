...
@test SafeUInt16(UInt8(2)) === SafeUInt16(2)
@test IntU16(SafeUInt8(2)) === IntU16(2)
@test SafeInt16(UInt8(2)) === SafeInt16(2)
@test UInt16(SafeInt8(2)) === UInt16(2)
@test SafeUInt16(Int8(2)) === SafeUInt16(2)
@test Int16(SafeUInt8(2)) === Int16(2)
